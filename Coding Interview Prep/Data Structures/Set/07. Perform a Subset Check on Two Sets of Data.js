...
// https://learn.freecodecamp.org/coding-interview-prep/data-structures/perform-a-subset-check-on-two-sets-of-data
...
function Set() {
  ...
  this.subset = setOther => {
    [...this.values()].map(i => {
      if (!setOther.has(i)) return false;
    });
