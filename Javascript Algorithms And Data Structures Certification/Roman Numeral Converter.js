...
const convertToRoman = num => {
  ...
  const nums = {
    th: 'M',
    hn: [[9, 'CM'], [5, 'D'], [4, 'CD'], [1, 'C']],
    tn: [[9, 'XC'], [5, 'L'], [4, 'XL'], [1, 'X']],
    rm: [[9, 'IX'], [5, 'V'], [4, 'IV'], [1, 'I']]
  };

  let th = Math.floor(num / 1000);
  let hn = Math.floor(num / 100) - 10 * th;
  let tn = Math.floor(num / 10) - 100 * th - 10 * hn;
  let rm = num - 1000 * th - 100 * hn - 10 * tn;
